...
```bash
wget https://github.com/Alonza0314/it-system/releases/download/v1.0.0/it-system-controller_1.0.0_amd64.deb
sudo dpkg -i it-system-controller_1.0.0_amd64.deb
```
...
```bash
wget https://github.com/Alonza0314/it-system/releases/download/v1.0.0/it-system-runner_1.0.0_amd64.deb
sudo dpkg -i it-system-runner_1.0.0_amd64.deb
```
